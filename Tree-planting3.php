            ...
            <div class="form">
                <form action="" method="post" class="formm">
                    ...
                    <div class="caste-info info">
                        ...
                        <div class="form-group required form-row">
                            <label for="aadharnumber" class="control-label aadhar">Upload Your Caste Certificate</label>
                            <div class="file3">
                                <form action="/action_page.php" class="col-md-4">
                                    <input type="file" id="myFile" name="filename" class="input-file2">
                                </form>
                    ...
                    <div class="buttons">
                        <a href="./Tree-planting2.php" class="back btn btn-primary"> Back</a>
                        <a href="./Welcome.php" class=" submit btn btn-success"> Submit</a>
                    </div>
            </div>
            </form>
        </div>
