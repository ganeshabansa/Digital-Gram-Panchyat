...
<body>
    ...
    <div class="container">
        <div class="container mt-4">
            ...
            <hr>
            <div class="formm">
                <form action="individual-farms3.php" method="GET">
                    <div class="form-row">
                    ...
                    <a href="/Individual-farms.html" id="back" class="btn btn-primary">Back</a> 
                    <button type="submit" id="continue" class="btn btn-success" value="Submit">Continue</a>
                </form>
            </div>
        </div>
    </div>
